...
<<<<<<< HEAD:Lab_5/ProdCons.c
  for(i = 0; i < numConsumers; i++){
=======
<<<<<<< HEAD:Lab5/ProdCons.c
  for(i = 0; i < numConsumers; i++){
=======
	for(int i = 0; i < numConsumers; i++){
>>>>>>> 2aaee2b05c2d310eab017df92dd3d8b6f8e0b1e8:Lab_5/ProdCons.c
>>>>>>> dev:Lab5/ProdCons.c
